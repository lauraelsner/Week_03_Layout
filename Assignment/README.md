...
![Relaxr Blog](relaxr_blog_deliverable.jpg)
...
- Use the correct ```Open Sans``` Google Font typeface to style the text denoted in the [design file](starter_code/design_file.txt) and according to the JPEG provided
...
- [Starter Code and Design File](starter_code/design_file.txt)
